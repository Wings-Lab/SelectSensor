...
def figure_2b(selectsensor):
    ...
    #save_data(plot_data, 'plot_data16/Online_Random_hetero.csv')

    #plot_data = selectsensor.select_online_nearest_hetero(6, 4, 250)
    #save_data(plot_data, 'plot_data16/Online_Nearest_hetero.csv')

    plot_data = selectsensor.select_online_greedy_hetero(4, 4, 250)
